...
O projeto contém a V3 conceitual do convite web de Douglas e Regiane, criada a partir de `prompt3.md`.

A experiência deixou de ser uma sequência rígida de seções e passou a usar narrativa contínua, tipografia editorial, fundo cinematográfico leve, glassmorphism refinado, glow champagne seletivo, fotos com parallax e microinterações discretas.
